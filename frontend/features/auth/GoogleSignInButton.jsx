...
export default function GoogleSignInButton({ callbackUrl = '/' }) {
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-2 border border-navy/15 rounded-md py-3 text-sm font-medium text-navy hover:bg-beige transition-colors"
    >
